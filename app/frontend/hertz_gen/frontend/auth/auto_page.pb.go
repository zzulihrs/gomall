...
func (x *RegisterReq) Reset() {
	*x = RegisterReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auto_page_proto_msgTypes[0]
...
func (*RegisterReq) Descriptor() ([]byte, []int) {
	return file_auto_page_proto_rawDescGZIP(), []int{0}
}
...
func (x *LoginReq) Reset() {
	*x = LoginReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_auto_page_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoginReq) Descriptor() ([]byte, []int) {
	return file_auto_page_proto_rawDescGZIP(), []int{1}
}
...
var File_auto_page_proto protoreflect.FileDescriptor

var file_auto_page_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x61, 0x75, 0x74, 0x6f, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
...
var (
	file_auto_page_proto_rawDescOnce sync.Once
	file_auto_page_proto_rawDescData = file_auto_page_proto_rawDesc
)

func file_auto_page_proto_rawDescGZIP() []byte {
	file_auto_page_proto_rawDescOnce.Do(func() {
		file_auto_page_proto_rawDescData = protoimpl.X.CompressGZIP(file_auto_page_proto_rawDescData)
	})
	return file_auto_page_proto_rawDescData
}

var file_auto_page_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_auto_page_proto_goTypes = []interface{}{
	(*RegisterReq)(nil),  // 0: frontend.auth.RegisterReq
	(*LoginReq)(nil),     // 1: frontend.auth.LoginReq
	(*common.Empty)(nil), // 2: frontend.common.Empty
}
var file_auto_page_proto_depIdxs = []int32{
...
func init() { file_auto_page_proto_init() }
func file_auto_page_proto_init() {
	if File_auto_page_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_auto_page_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_auto_page_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_auto_page_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_auto_page_proto_goTypes,
		DependencyIndexes: file_auto_page_proto_depIdxs,
		MessageInfos:      file_auto_page_proto_msgTypes,
	}.Build()
	File_auto_page_proto = out.File
	file_auto_page_proto_rawDesc = nil
	file_auto_page_proto_goTypes = nil
	file_auto_page_proto_depIdxs = nil
}
